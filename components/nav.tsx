      ...
      <NavigationMenuList>
          ...
          <Link href="/portal" legacyBehavior passHref>
            <NavigationMenuLink
              className={`${navigationMenuTriggerStyle()} ${
                pathname === '/portal' ? 'text-primary font-semibold' : 'text-muted-foreground'
              }`}
            >
        ...
        <NavigationMenuItem>
          <Link href="/portal/customer" legacyBehavior passHref>
            <NavigationMenuLink
              className={`${navigationMenuTriggerStyle()} ${
                pathname === '/portal/customer' ? 'text-primary' : 'text-muted-foreground'
              }`}
            >
        ...
        <NavigationMenuItem>
          <Link href="/portal/order" legacyBehavior passHref>
            <NavigationMenuLink
              className={`${navigationMenuTriggerStyle()} ${
                pathname === '/portal/order' ? 'text-primary' : 'text-muted-foreground'
              }`}
            >
